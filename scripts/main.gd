...
func make_levels():
	...
	demons_to_summon.append(Demon.new(4, "Asmodeus", "Demon of Lust and Temptation", null, null, ["I am Asmodeus! Do you desire me?", "No! You desire knowledge.", "Dont you know knowledge is the dirtiest of all desires!"], "Blood chalices increase the value of surrounding (non-diagonal) offerings by one."))
