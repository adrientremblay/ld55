...
func make_levels():
	demons_to_summon.append(Demon.new("Abaddon", "Demon of Desolation and Ruin", null, null, ["I am Abaddon! Am I the first demon you've ever seen?", "I can tell you men bring ruin upon themselves.", "But for the secrets of wrath and violence, you must consult Moloch!"]))
